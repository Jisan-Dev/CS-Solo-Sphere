          ...
          <div className="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
            <div>
              ...
              <input
                ...
                type="text"
                name="price"
                className="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-200 rounded-md   focus:border-slate-400 focus:ring focus:ring-slate-300 focus:ring-opacity-40 focus:outline-none "
              />
            </div>
