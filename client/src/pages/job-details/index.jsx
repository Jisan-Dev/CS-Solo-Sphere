    ...
    <div className="flex flex-col md:flex-row justify-around gap-5  items-center min-h-[calc(100vh-306px)] md:max-w-screen-xl mx-auto ">
      ...
      <div className="flex-1  px-4 py-7 bg-white rounded-md shadow-md md:min-h-[350px]">
        <div className="flex items-center justify-between">
          <span className="text-sm font-light text-gray-800 ">Deadline: 12/08/2024</span>
          <span className="px-4 py-1 text-xs text-blue-800 uppercase bg-blue-200 rounded-full ">Web Development</span>
        </div>

        <div>
          <h1 className="mt-2 text-3xl font-semibold text-gray-800 ">Build Dynamic Website</h1>
          ...
          <p className="mt-6 text-lg font-bold text-gray-600 ">Range: $100 - $150</p>
        </div>
      </div>
      {/* Place A Bid Form */}
